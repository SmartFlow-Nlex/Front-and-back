    ...
    xAxis: {
      ...
      axisLabel: {
        ...
        interval: (index: number) => {
          if (granularity === "Yearly") return index % 14 === 0;
          if (granularity === "Monthly") return index % 5 === 0;
          return index % 3 === 0;
        },
      },
    },
      ...
      <div style={{
        ...
        <span style={{ display: "inline-flex", alignItems: "center", gap: "8px" }}>
          ...
          <div style={{
            ...
            {/* Daily */}
            <button
              onClick={() => { setGranularity("Daily"); setPastDays(30); }}
              style={{
                padding: "3px 10px", borderRadius: "999px", cursor: "pointer", border: "none",
                background: granularity === "Daily" ? "transparent" : "transparent",
                color: granularity === "Daily" ? "#2563eb" : "#4b5e7d",
                fontWeight: granularity === "Daily" ? 700 : 600, fontSize: "0.72rem",
              }}
            >
            ...
            {/* Monthly */}
            <button
              onClick={() => { setGranularity("Monthly"); setPastDays(30); }}
              style={{
                padding: "3px 10px", borderRadius: "999px", cursor: "pointer", border: "none",
                background: granularity === "Monthly" ? "transparent" : "transparent",
                color: granularity === "Monthly" ? "#2563eb" : "#4b5e7d",
                fontWeight: granularity === "Monthly" ? 700 : 600, fontSize: "0.72rem",
              }}
            >
              {granularity === "Monthly" ? "✓ Monthly" : "Monthly"}
            </button>
            {/* Yearly */}
            <button
              onClick={() => { setGranularity("Yearly"); setPastDays(365); }}
              style={{
                padding: "3px 10px", borderRadius: "999px", cursor: "pointer", border: "none",
                background: granularity === "Yearly" ? "transparent" : "transparent",
                color: granularity === "Yearly" ? "#2563eb" : "#4b5e7d",
                fontWeight: granularity === "Yearly" ? 700 : 600, fontSize: "0.72rem",
              }}
            >
              {granularity === "Yearly" ? "✓ Yearly" : "Yearly"}
            </button>
          </div>
        </span>
        ...
        <span style={{ display: "inline-flex", alignItems: "center", gap: "8px" }}>
          ...
          {[
            ...
            <button key={item.label} onClick={() => setPastDays(item.d)} style={{
              padding: "3px 10px", borderRadius: "999px", cursor: "pointer",
              border: pastDays === item.d ? "1px solid #2563eb" : "1px solid #dce2ef",
              background: pastDays === item.d ? "#2563eb" : "#fff",
              color: pastDays === item.d ? "#fff" : "#4b5e7d", fontWeight: 600, fontSize: "0.72rem",
            }}>{item.label}</button>
          ))}
        </span>
