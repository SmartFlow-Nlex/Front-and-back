...
const supabaseProjects = [
  {
    ...
    url: 'postgresql://postgres.hunmrgnszbaqizpdmseq:REMOVED@aws-1-ap-northeast-1.pooler.supabase.com:6543/postgres?sslmode=require'
  },
  {
    name: 'eoyopmstogazaflwisbg (Date-Warehouse-Airline)',
    url: 'postgresql://postgres.eoyopmstogazaflwisbg:REMOVED@aws-0-ap-southeast-1.pooler.supabase.com:6543/postgres?sslmode=require'
  }
];
