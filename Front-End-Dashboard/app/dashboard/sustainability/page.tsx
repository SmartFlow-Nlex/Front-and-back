...
import { CloudRain, Factory, Leaf, Wrench } from "lucide-react";
  ...
  return (
    <section className="ds-content ds-long">
      ...
      <section className="panel">
        <h2>Where to Upload Batch Data</h2>
        <p className="muted">Use the Data Management tab to upload your CSV or JSON batch. This page only shows the emissions overview and charts.</p>
      </section>
