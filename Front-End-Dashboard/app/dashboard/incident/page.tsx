                  ...
                  <div style={{ background: "#fff", borderRadius: "12px", padding: "20px 28px", boxShadow: "0 1px 3px rgba(0,0,0,0.07)", border: "1px solid #e2e8f0", boxSizing: "border-box", width: "100%" }}>
                    ...
                    <div style={{ overflowX: "auto" }}>
                      <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.875rem" }}>
                        ...
                        <tbody>
                          {predictiveData.modelComparison.map((m, i) => (
                            <tr key={i} style={{ borderBottom: "1px solid #f1f5f9", background: m.isChampion ? "#f0fdf4" : "transparent" }}>
                              ...
                              <td style={{ padding: "11px 14px", color: "#64748b", fontVariantNumeric: "tabular-nums" }}>{m.MAE !== null ? m.MAE.toFixed(6) : "N/A"}</td>
                              <td style={{ padding: "11px 14px", color: "#64748b", fontVariantNumeric: "tabular-nums" }}>{m.Poisson_Deviance !== null ? m.Poisson_Deviance.toFixed(6) : "N/A"}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
